package com.calclavia.edx.mechanical.mech.grid

import com.calclavia.edx.api.energy.TNodeMechanical
import com.calclavia.edx.core.prefab.node.TMultipartNode
import nova.core.block.component.Connectable
import nova.core.component.{Component, ComponentProvider}
 ...
 */
class MechanicalComponent(parent: ComponentProvider) extends Component with Connectable[MechanicalComponent] with TMultipartNode[MechanicalComponent] with TNodeMechanical {
	/**
	 * Angle calculations
	 */
	 ...
	 */
	override protected def getCompareClass = classOf[MechanicalComponent]
}