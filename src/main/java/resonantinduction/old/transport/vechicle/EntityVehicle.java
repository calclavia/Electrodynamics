...
import resonantinduction.old.lib.interfaces.IControlReceiver;
...
public abstract class EntityVehicle extends EntityAdvanced implements IControlReceiver, ISimplePacketReceiver
{
	...
	{
		// System.out.println("Key: " + keycode + "  P: " + (player != null ? player.username :
		// "null"));
		...
		else
		{
			...
			if (ticks % 5 == 0)
			{
				if (worldObj.isRemote)
					// PacketManagerEntity.sendEntityUpdatePacket(this, this.worldObj.isRemote,
					// "Desc", this.posX, this.posY, this.posZ, this.rotationYaw,
	...
	public boolean attackEntityFrom(DamageSource source, float damage)
	{
		...
		// TODO take extra damage from explosion including damaging vehicle parts. As well knock
		// player out of vehicle if it was right next to the vehicle
		...
		// TODO on radiation damage have the vehicle carry the radiation to damage players who use
		// the vehicle
