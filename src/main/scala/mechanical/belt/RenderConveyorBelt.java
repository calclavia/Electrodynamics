...
public class RenderConveyorBelt extends TileEntitySpecialRenderer implements ISimpleItemRenderer
{
    ...
    public void renderTileEntityAt(TileEntity t, double x, double y, double z, float f)
    {
        ...
        final TileConveyorBelt.BeltType slantType = beltTile.getBeltType();
        ...
        /* Assign texture */
        bindTexture(getTexture(slantType == TileConveyorBelt.BeltType.SLANT_UP || slantType == TileConveyorBelt.BeltType.SLANT_DOWN, frame));
        
        if (slantType != null && slantType != TileConveyorBelt.BeltType.NORMAL)
        {
            switch (face)
            {
                case 2:
            ...
            if (slantType == TileConveyorBelt.BeltType.SLANT_UP)
            {
                ...
                if (test != null)
                {
                    ...
                    {
                        if (((TileConveyorBelt) test).getBeltType() == TileConveyorBelt.BeltType.RAISED)
                        {
