...
import mffs.production.ContainerCoercionDeriver;
...
public class GuiCoercionDeriver extends GuiMFFS
{
	...
	protected void drawGuiContainerForegroundLayer(int x, int y)
	{
		...
		this.renderUniversalDisplay(85, 30, this.tileEntity.getPower(), x, y, Unit.WATT);
		...
		this.fontRenderer.drawString((this.tileEntity.isInversed ? "\u00a74-" : "\u00a72+") + UnitDisplay.getDisplayShort(this.tileEntity.productionRate() * 20, Unit.LITER) + "/s", 118, 117, 4210752);
