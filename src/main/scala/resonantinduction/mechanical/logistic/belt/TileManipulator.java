...
public class TileManipulator extends TileFilterable implements IRotatable, IManipulator, IPacketReceiver
{
	...
	public void enject()
	{
		...
		outputUp.add(ForgeDirection.UP);
		...
		outputPosition.add(this.getDirection().getOpposite());
	...
	public void inject()
	{
		...
		/** input location up */
		Vector3 inputUp = new Vector3(this).add(ForgeDirection.UP);
		/** input location down */
		Vector3 inputDown = new Vector3(this).add(ForgeDirection.DOWN);
		/** input location facing */
		Vector3 inputPosition = new Vector3(this).add(this.getDirection().getOpposite());
		/** output location facing */
		Vector3 outputPosition = new Vector3(this).add(this.getDirection());
